...
public class ShadowTests {
     ...
     */
    //TC01: original Triangle shadow above sphere
    @Test
    ...
    //TC02:moving Triangle above sphere
    @Test
...
//            );
//		scene.lights.add( //
//                new SpotLight(new Color(400, 240, 0), new Point3D(-100, -100, 200), new Vector3D(1, 1, -3)) //
//            .setKl(1E-5).setKq(1.5E-7));


    //TC03: moving Triangle above sphere
    @Test
    ...
    //TC04: The light is little close to geometries
    @Test
    public void sphereTriangleInitial4() {
        ...
        scene.lights.add( //
                new SpotLight(new Color(400, 240, 0), new Point3D(-87, -87, 110), new Vector(1, 1, -3)) //
                        .setKl(1E-5).setKq(1.5E-7));
    ...
    //TC05: The light is close to geometries
    @Test
